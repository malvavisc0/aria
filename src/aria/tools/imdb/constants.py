...
ERROR_INVALID_TITLE_TYPE = (
    "Invalid title_type '{value}'. Valid types: {valid_types}"
)
...
ERROR_NETWORK = (
    "Network error: Unable to connect to IMDb. Please try again later."
)
ERROR_TIMEOUT = (
    "Request timed out. IMDb may be slow to respond. Please try again."
)
ERROR_RATE_LIMIT = (
    "Rate limited by IMDb. Please wait a moment before trying again."
)
