...
class Ui_EditUserDialog(object):
    def setupUi(self, EditUserDialog):
        ...
        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.lineEdit_Email)
        ...
        self.label_PasswordHint.setObjectName(u"label_PasswordHint")

        self.formLayout.setWidget(3, QFormLayout.ItemRole.LabelRole, self.label_PasswordHint)

        self.label_PasswordHintText = QLabel(self.formLayoutWidget)
        self.label_PasswordHintText.setObjectName(u"label_PasswordHintText")
        self.label_PasswordHintText.setStyleSheet(u"color: rgb(104, 104, 104); font-style: italic;")

        self.formLayout.setWidget(3, QFormLayout.ItemRole.FieldRole, self.label_PasswordHintText)
    ...
    def retranslateUi(self, EditUserDialog):
        EditUserDialog.setWindowTitle(QCoreApplication.translate("EditUserDialog", u"Edit User", None))
        self.label_Name.setText(QCoreApplication.translate("EditUserDialog", u"Name:", None))
        self.label_Email.setText(QCoreApplication.translate("EditUserDialog", u"Email:", None))
        self.label_Password.setText(QCoreApplication.translate("EditUserDialog", u"Password:", None))
        self.label_PasswordHint.setText("")
        self.label_PasswordHintText.setText(QCoreApplication.translate("EditUserDialog", u"Leave empty to keep current password", None))
        self.pushButton_Save.setText(QCoreApplication.translate("EditUserDialog", u"Save", None))
        self.pushButton_Cancel.setText(QCoreApplication.translate("EditUserDialog", u"Cancel", None))
    # retranslateUi
