...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_KVCacheOffloadMode.setObjectName("label_KVCacheOffloadMode")

        self.formLayout_settingsAdvanced.setWidget(
            3, QFormLayout.ItemRole.LabelRole, self.label_KVCacheOffloadMode
        )
        ...
        self.comboBox_KVCacheOffloadMode.addItem("")
        self.comboBox_KVCacheOffloadMode.addItem("")
        self.comboBox_KVCacheOffloadMode.setObjectName("comboBox_KVCacheOffloadMode")

        self.formLayout_settingsAdvanced.setWidget(
            3, QFormLayout.ItemRole.FieldRole, self.comboBox_KVCacheOffloadMode
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_KVCacheOffloadMode.setText(
            QCoreApplication.translate("MainWindow", "KV cache offload", None)
        )
        # if QT_CONFIG(tooltip)
        self.label_KVCacheOffloadMode.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Controls how the KV cache is stored when GPU VRAM is insufficient. 'off' = GPU-only, 'auto' = offload to RAM when VRAM is tight, 'ram' = force RAM offload.",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.comboBox_KVCacheOffloadMode.setItemText(
            0, QCoreApplication.translate("MainWindow", "off", None)
        )
        self.comboBox_KVCacheOffloadMode.setItemText(
            1, QCoreApplication.translate("MainWindow", "auto", None)
        )
        self.comboBox_KVCacheOffloadMode.setItemText(
            2, QCoreApplication.translate("MainWindow", "ram", None)
        )

        # if QT_CONFIG(tooltip)
        self.comboBox_KVCacheOffloadMode.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Controls how the KV cache is stored when GPU VRAM is insufficient. 'off' = GPU-only, 'auto' = offload to RAM when VRAM is tight, 'ram' = force RAM offload.",
                None,
